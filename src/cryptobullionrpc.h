...
#ifndef _CRYPTOBULLIONRPC_H_
#define _CRYPTOBULLIONRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Cryptobullion is not connected
...
/**
 * Cryptobullion RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value hardstake(const json_spirit::Array& params, bool fHelp);
