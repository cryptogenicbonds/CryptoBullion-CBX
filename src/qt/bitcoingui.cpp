...
{
    resize(850, 550);
    setWindowTitle(tr("CGB") + " - " + tr("Vault"));
#ifndef Q_OS_MAC
    ...
    debugPage = new DebugDialog(this);
...
{
    //sendCoinsAction->setChecked(true);
    centralWidget->setCurrentWidget(debugPage);
