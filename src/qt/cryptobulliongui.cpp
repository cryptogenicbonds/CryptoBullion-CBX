/*
 * Qt4 cryptobullion GUI.
 *
 * W.J. van der Laan 2011-2012
 * The Cryptobullion Developers 2011-2012
 */
...
CryptobullionGUI::CryptobullionGUI(bool fIsTestnet, QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/cryptobullion"));
    setWindowIcon(QIcon(":icons/cryptobullion"));
#else
...
CryptobullionGUI::~CryptobullionGUI()
{
...
void CryptobullionGUI::resizeEvent(QResizeEvent *)
{
    /*
...
void CryptobullionGUI::createActions()
{
    ...
    switchSkinAction = new QAction(QIcon(":/icons/switchskin"), tr("&Toggle Dark/Light skin"), this);
...
void CryptobullionGUI::createMenuBar()
{
#ifdef Q_OS_MAC
...
void CryptobullionGUI::createToolBars()
{
...
void CryptobullionGUI::setClientModel(ClientModel *clientModel)
{
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/cryptobullion_testnet"));
            setWindowIcon(QIcon(":icons/cryptobullion_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/cryptobullion_testnet"));
#endif
            if(trayIcon)
            {
...
void CryptobullionGUI::setWalletModel(WalletModel *walletModel)
{
...
void CryptobullionGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
...
#ifndef Q_OS_MAC
void CryptobullionGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void CryptobullionGUI::optionsClicked()
{
...
void CryptobullionGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
...
void CryptobullionGUI::setNumBlocks(int count, int nTotalBlocks)
{
...
void CryptobullionGUI::error(const QString &title, const QString &message, bool modal)
{
    // Report errors from network/worker thread
    if(modal)
    {
...
void CryptobullionGUI::changeEvent(QEvent *e)
{
...
void CryptobullionGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void CryptobullionGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
	  ...
	  "over time. Do you want to pay the fee?").arg(
                CryptobullionUnits::formatWithUnit(CryptobullionUnits::BTC, nFeeRequired));
...
void CryptobullionGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
            ...
            notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(CryptobullionUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void CryptobullionGUI::gotoOverviewPage()
{
...
void CryptobullionGUI::gotoHistoryPage()
{
...
void CryptobullionGUI::gotoAddressBookPage()
{
...
void CryptobullionGUI::gotoReceiveCoinsPage()
{
...
void CryptobullionGUI::gotoSendCoinsPage()
{
    //gotoDebugPage();
    //return;
...
void CryptobullionGUI::gotoSignMessageTab(QString addr)
{
...
void CryptobullionGUI::gotoVerifyMessageTab(QString addr)
{
...
void CryptobullionGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void CryptobullionGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
void CryptobullionGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void CryptobullionGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void CryptobullionGUI::backupWallet()
{
...
void CryptobullionGUI::changePassphrase()
{
...
void CryptobullionGUI::unlockWallet(bool showMintOption)
{
    if(!walletModel)
        return;
...
void CryptobullionGUI::handleUnlockButtonState()
{
...
void CryptobullionGUI::toggleWalletLock()
{
    if(!walletModel)
        return;
